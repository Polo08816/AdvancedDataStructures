...
/**
 * 
 * The Project6 is a program that constructs a map of the United States excluding Hawaii and Alaska.
 * BFS and DFS traversals are used to visit each state based on an adjacency matrix and color each state
 * such that no adjacent states are the same color.
 * 
 * 
 * @param file Adjacency list.
 * @param file list of states.
 * @return string A sequence of states according to the order they were visited, 
 * along with their color assignments. BFS also needs to display the level numbers.
 * 
 * @author Kevin Kuo
 * @version 1.0
 *
